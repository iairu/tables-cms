...
<style>
  ...
  .editor-fullscreen { position: fixed; inset: 0; background: var(--bg-card, white); z-index: 1000; padding: 20px; overflow-y: auto; }
  ...
  .data-table { width: 100%; background: var(--bg-card, white); border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08); }
  ...
  .empty { text-align: center; padding: 60px; background: var(--bg-card, white); border-radius: 12px; }
